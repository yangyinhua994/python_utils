...
java_name = base.get_file_name_last_upper() + "Dto"
...
for i in range(len(base.dto_not_check_null_fields)):
    base.dto_not_check_null_fields[i] = snake_to_camel(base.dto_not_check_null_fields[i])
