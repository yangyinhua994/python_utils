...
controller_fime_name = "TexturesServerImpl.java"
intercept = "ServerImpl.java"
...
def start():
    ...
    with open(controller_fime_name, "r") as controllerFile:
        ...
        base.write_file(data, base.service_impl_path + "/" + base.get_file_name_last_upper() + intercept)
